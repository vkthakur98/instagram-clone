        ...
        <div className='image-post'>
            ...
            <div className='body-post'>
                ...
                <div className='post-actions-wrap'>
                  <div className='post-actions'><div className='post-action-lcs'><div><i className="fa-regular fa-heart"></i></div><div><i className="fa-regular fa-comment"></i></div><div><i className="fa-regular fa-paper-plane"></i></div></div><div className='post-action-save'><div><i className="fa-regular fa-bookmark"></i></div></div></div>
                </div>
           </div>
        </div>
      </div>
